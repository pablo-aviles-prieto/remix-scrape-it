...
type MailPayload = Omit<CreateEmailOptions, 'from'> &
...
class ResendClient {
  ...
  public async sendMail(payload: MailPayload, options?: CreateEmailRequestOptions) {
    const mergedPayload = {
      from: `ScrapeIt Info <${this.senderMail}>`,
      ...payload,
    };
