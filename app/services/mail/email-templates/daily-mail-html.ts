    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="left">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:40% !important; width:100%; height:auto !important;" width="265" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/813cb5b8a71a401b/2a5436c4-ac15-4006-8166-74f569d75a03/431x578.png">
        </td>
      </tr>
    </tbody>
  </table></td>
      ...
      <tr>
        <td style="padding:0px 0px 9px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">
            <ul style="list-style-type: none; padding: 0; margin: 0;">
                {{#each prices}}
                    <li style="padding: 0; margin: 0; margin-bottom: 2px;">{{this.date}}: {{this.price}}€</li>
                {{/each}}
