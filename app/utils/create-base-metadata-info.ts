...
export const createBaseMetadataInfo: MetaFunction = () => {
  ...
  const titleData = 'ScrapeIt! - Consigue los mejores precios de tus tiendas favoritas';
  ...
  return [
    ...
    { property: 'og:url', content: 'https://www.scrapeit.pabloaviles.dev/' },
    {
      property: 'og:image',
      content: 'https://www.scrapeit.pabloaviles.dev/images/scrapeit_social_network.webp',
    },
  ];
};
